...
public class HomeAddress implements Address{
    ...
    public HomeAddress(String province, String country, String district, String street, int no) {
    ...
    public void showAddressInfo(int id) {
        System.out.println("Ev adresi= "+"ID: "+id+"\t\til: "+this.province+"\t\tilçe: "+this.country+
